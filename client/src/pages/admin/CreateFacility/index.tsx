...
import { GetCinema, CreateFacility } from "@api/cinema/queries";
import { GetDistrict, GetProvince, GetWard } from "@api/location/queries";

function CreateFacilityCinema() {
  ...
  const { mutate: createFacility, isPending } = CreateFacility();
  ...
  return (
    <div className="p-10  pt-[70px]">
      <h1 className="text-center text-[20px] font-semibold mb-4 text-[#8fbdff]">Thêm cơ sở</h1>
        ...
        <Card className="bg-[#0f1d2f] py-2 box-shadow border-none text-[#8fbdff] ">
          <Row gutter={[32, 32]}>
                  ...
                  onChange={(value) => {
                    getDistrict(value, {
                      onSuccess: (result) => {
                        ...
                        formCreateCinema.setFieldsValue({ district: undefined, ward: undefined });
                      },
                    });
                  }}
                  allowClear
                  ...
                  onChange={(value) => {
                    getWard(value, {
                      onSuccess: (result) => {
                        ...
                        formCreateCinema.setFieldsValue({ ward: undefined });
                      },
                    });
                  }}
                  disabled={!formCreateCinema.getFieldValue("province")}
                  allowClear
                >
                  {renderDistrict}
                </Select>
            ...
            <Col span={8}>
              ...
              >
                <Select disabled={!formCreateCinema.getFieldValue("district")} allowClear>
                  {renderWard}
                </Select>
              </Form.Item>
            </Col>
...
export default CreateFacilityCinema;
